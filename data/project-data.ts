...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Maintained and architected the database of Speedway's customer loyalty program, Speedy Rewards, ensuring efficient data management and seamless user experience for millions of customers. This involved optimizing database performance, implementing robust data security measures, and supporting the scalability needs of the loyalty program as it continues to grow.",
  },
  {
    sortOrder: 5,
    title: "Enterprise Data Database",
    description:
      "Maintained a robust database architecture for Speedway's enterprise data, ensuring efficient storage, retrieval, and management of critical information across multiple business units. This architecture supports the scalability and performance needs of the organization while maintaining data integrity and security.",
  },
];
